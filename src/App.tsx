  ...
  return (
    <main>
      ...
      <Section>
        ...
        <Text>
          사용자 경험과 개발자 경험 향상을 중요한 가치로 여기는 프론트엔드
          개발자입니다.
        </Text>
        <Text>
          이를 위해 동료와의 협업 방식 개선, 개발 환경 및 경험 향상, 문서화의
          중요성을 인식하고 적극적으로 기여해 왔으며,
          <br />
          반복적인 업무의 비효율을 줄이고 동료들의 문제를 해결하고 동료들에게
          긍정적인 피드백을 받을 때 큰 보람과 동기부여를 얻습니다.
        </Text>
        <Text>
        ...
        <Text>
          이 경험을 바탕으로 CI/CD 자동화, 협업 프로세스 개선 등 다양한 개발 및
